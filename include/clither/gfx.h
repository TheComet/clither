...
struct gfx_interface
{
     ...
     */
    struct gfx*
    (*create)(int initial_width, int initial_height);
     ...
     */
    int
    (*load_resource_pack)(struct gfx* gfx, const struct resource_pack* pack);
     ...
     */
    void
    (*poll_input)(struct gfx* gfx, struct input* input);
     ...
     */
    void
    (*step_anim)(struct gfx* gfx, int sim_tick_rate);

    /*!
     * \brief Draw everything.
     */
    void
    (*draw_world)(struct gfx* gfx, const struct world* world, const struct camera* camera);
};
