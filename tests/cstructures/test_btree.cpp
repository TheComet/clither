...
TEST(NAME, insertion_forwards)
{
    ...
    ASSERT_THAT(btree_insert_new(&btree, 0, &a), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(1u));
    ASSERT_THAT(btree_insert_new(&btree, 1, &b), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(2u));
    ASSERT_THAT(btree_insert_new(&btree, 2, &c), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(3u));
    ASSERT_THAT(btree_insert_new(&btree, 3, &d), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(4u));
    ASSERT_THAT(btree_insert_new(&btree, 4, &e), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(5u));
...
TEST(NAME, insertion_backwards)
{
    ...
    int a=56, b=45, c=18, d=27, e=84;
    ASSERT_THAT(btree_insert_new(&btree, 4, &a), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(1u));
    ASSERT_THAT(btree_insert_new(&btree, 3, &b), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(2u));
    ASSERT_THAT(btree_insert_new(&btree, 2, &c), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(3u));
    ASSERT_THAT(btree_insert_new(&btree, 1, &d), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(4u));
    ASSERT_THAT(btree_insert_new(&btree, 0, &e), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(5u));
...
TEST(NAME, insertion_random)
{
    ...
    int a=56, b=45, c=18, d=27, e=84;
    ASSERT_THAT(btree_insert_new(&btree, 26, &a), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(1u));
    ASSERT_THAT(btree_insert_new(&btree, 44, &b), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(2u));
    ASSERT_THAT(btree_insert_new(&btree, 82, &c), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(3u));
    ASSERT_THAT(btree_insert_new(&btree, 41, &d), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(4u));
    ASSERT_THAT(btree_insert_new(&btree, 70, &e), Eq(BTREE_OK));  ASSERT_THAT(btree_count(&btree), Eq(5u));
...
TEST(NAME, insert_new_with_realloc_shifts_data_correctly)
{
    ...
    cs_btree_size midway = CSTRUCTURES_BTREE_MIN_CAPACITY / 2;
...
TEST(NAME, compact_reduces_capacity_and_keeps_elements_in_tact)
{
    ...
    for (int i = 0; i != CSTRUCTURES_BTREE_MIN_CAPACITY * 3; ++i)
        ASSERT_THAT(btree_insert_new(&btree, i, &a), Eq(BTREE_OK));
    for (int i = 0; i != CSTRUCTURES_BTREE_MIN_CAPACITY; ++i)
        btree_erase(&btree, i);
...
TEST(NAME, insert_new_existing_keys_fails)
{
    ...
    int a=53;
    EXPECT_THAT(btree_insert_new(&btree, 0, &a), Eq(BTREE_OK));
    EXPECT_THAT(btree_insert_new(&btree, 0, &a), Eq(BTREE_EXISTS));
...
TEST(NAME, set_existing_fails_if_key_doesnt_exist)
{
    ...
    int a=53;
    EXPECT_THAT(btree_set_existing(&btree, 0, &a), Eq(BTREE_NOT_FOUND));
...
TEST(NAME, set_existing_key_works_on_keys_that_exist)
{
    ...
    EXPECT_THAT(btree_insert_new(&btree, 7, &a), Eq(BTREE_OK));
    EXPECT_THAT(btree_insert_new(&btree, 3, &b), Eq(BTREE_OK));
    EXPECT_THAT(btree_set_existing(&btree, 3, &d), Eq(BTREE_OK));
    EXPECT_THAT(btree_set_existing(&btree, 7, &c), Eq(BTREE_OK));
...
TEST(NAME, reinsertion_forwards)
{
    ...
    int a=56, b=45, c=18, d=27, e=84;
    ASSERT_THAT(btree_insert_new(&btree, 0, &a), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 1, &b), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 2, &c), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 3, &d), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 4, &e), Eq(BTREE_OK));
...
TEST(NAME, reinsertion_random)
{
    ...
    int a=56, b=45, c=18, d=27, e=84;
    ASSERT_THAT(btree_insert_new(&btree, 26, &a), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 44, &b), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 82, &c), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 41, &d), Eq(BTREE_OK));
    ASSERT_THAT(btree_insert_new(&btree, 70, &e), Eq(BTREE_OK));
