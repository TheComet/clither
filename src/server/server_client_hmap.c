...
static int server_client_hmap_kvs_alloc(
    struct server_client_hmap_kvs* kvs,
    struct server_client_hmap_kvs* old_kvs,
    int16_t                        capacity)
{
    (void)old_kvs;
...
HMAP_DEFINE_FULL(
    ...
    16,
    server_client_hmap_kvs_hash,
    server_client_hmap_kvs_alloc,
    server_client_hmap_kvs_free_old,
    server_client_hmap_kvs_free,
    server_client_hmap_kvs_get_key,
    server_client_hmap_kvs_set_key,
    server_client_hmap_kvs_keys_equal,
    server_client_hmap_kvs_get_value,
    server_client_hmap_kvs_set_value,
    16,
    70)
